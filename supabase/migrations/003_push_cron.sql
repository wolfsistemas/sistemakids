-- 003_push_cron.sql
-- Job diario: aniversariantes do dia (avisa o lider da celula).
-- 09:00 America/Sao_Paulo = 12:00 UTC (pg_cron roda em UTC).
--
-- No Sistema Kids nao ha tabela de eventos, entao a Edge Function
-- 'notificar-diario' trata apenas os aniversariantes.
--
...
declare
  v_secret text;
  v_url text := 'https://mxuvvsklqaelvxmpnzhe.supabase.co/functions/v1/notificar-diario';
begin
